...
NGLScene::NGLScene()
{
  ...
  playerpos.set(0,0,0);
  camPos.set(playerpos.m_x,playerpos.m_y,playerpos.m_z+cameradist);
}
...
//  camPos.m_z+=cameradist;

  https://www.gamedev.net/resources/_/technical/game-programming/a-simple-third-person-camera-r1591
  float camerax = cameradist * sin((yrot) * M_PI / 180) + playerpos.m_x;
...
// turn on wirframe rendering
  ...
  case Qt::Key_Up:
//    playerpos.m_z-=0.1;
    //calculate direction vector from camera to playerpos
    newForward.set(playerpos-m_cam.getEye().toVec3());
    playerpos+=newForward*0.1;
    break;
  case Qt::Key_Down:
      //playerpos.m_z+=0.1;
      //calculate direction vector from camera to playerpos
